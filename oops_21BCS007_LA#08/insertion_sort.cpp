...
// Function to perform insertion sort based on the magnitude of norms
...
int main()
{
    ...
    for (int k : arr)
    {
        ...
        // Output the result
        cout << "Sorting time for k = " << k << " : " << duration.count() << " microseconds" << endl;

        // Print norms for verification (comment out for large k values)
        // printNorms(objects);
